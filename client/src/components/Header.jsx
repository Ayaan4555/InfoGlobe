...
//   let country = ["India","Argentina" , "Australia" , "Austria" , "Belgium" , "Brazil" , "Bulgaria" , "Canada","China","Colombia","Cuba","Czech Republic","Egypt","France","Germany","Greece","Hong Kong","Hungary","Indonesia","Ireland","Israel","Italy","Japan","Latvia","Lithuania","Malaysia","Mexico","Morocco","Netherlands","New Zealand","Nigeria","Norway","Philippines","Poland","Portugal","Romania","Russia","Saudi Arabia","Serbia","Singapore","Slovakia","Slovenia","South Africa","South Korea","Sweden","Switzerland","Taiwan","Thailand","Turkey","UAE","Ukraine","United Kingdom","United States","Venuzuela","Yemen","Zambia","Zimbabwe"]
...
//      <nav className={theme==="light-theme"?"fixed top-0 left-0 w-full h-auto bg-[#000]  z-10 flex items-center justify-around ":"fixed top-0 left-0 w-full h-auto  z-10 flex items-center justify-around bg-[#000]"}>
      
//       <Link to='/'>
       

//       <h3 className="relative heading font-bold md:basis-1/6 text-2xl xs:basis-4/12 z-50 mb-5 mt-5 h3">InfoGlobe</h3>
//       {/* <img  width='70px' src={logo} className="logo" /> */}
...
//         <ul className={active ? "nav-ul flex gap-11 md:gap-14 xs:gap-12 lg:basis-3/6 md:basis-4/6 md:justify-end active" : " nav-ul flex gap-14 lg:basis-3/6 md:basis-4/6 justify-end none"}>
//           <li className="all"><Link className="no-underline font-semibold" to="/" onClick={() => { setActive(!active) }}>All News</Link></li>
//           <li className="dropdown-li all"><Link className="no-underline font-semibold flex items-center gap-2" onClick={() => { setShowCategoryDropdown(!showCategoryDropdown); setShowCountryDropdown(false) }}>Top-Headlines <FontAwesomeIcon className={showCategoryDropdown ? "down-arrow-icon down-arrow-icon-active" : "down-arrow-icon"} icon={faCircleArrowDown} /></Link>
...
//                     <Link to={"/country/" + element} className="flex gap-3 " type="btn"
//                       onClick={() => {
//                         setActive(!active)
//                       }}>
//                       {element}
...
//             </ul>
//           </li>
//           <li className="small-toggle"><Link className="no-underline font-semibold" to="#" onClick={() => { toggleTheme() }}>
...
//         <div className="mx-auto max-w-md flex justify-center right show">
...
//         />
//          <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-500 px-3.5 peer-focus:border-lime-300 peer-focus:stroke-white-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
//          <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
//          </svg>
...
// <Link to="/login">
//           <button className={theme==="light-theme"?"bg-[#FF6F61] hover:bg-[#BF5347] text-white font-bold py-2 px-4 rounded login-btn":"bg-[#CC0000] hover:bg-[#800000] text-white font-bold py-2 px-4 rounded login-btn"}>
//             Login
//           </button>
// </Link>
